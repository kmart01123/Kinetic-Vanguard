...
The Pyrokinesis candidate adds a Fighter-18 once-per-Attack-action 2d8 fire hit packet through Psionic Apex, with normal defenses and no critical doubling or resource cost. Validate focused sentinels and one frozen full benchmark before disposition. Other discipline maturation and the Psychokinesis/Refined Holdout intent remain separate decisions.
