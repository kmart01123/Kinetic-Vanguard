...
Integrated follow-up: Absolute Zero uses 6d10 + 45/55/65 cold damage; Telekinetic Shove increases to 4 force damage at every tier from Fighter 18; and Branching Bolt gains an optional two-die, single-target Focused Bolt from Fighter 18. Canonical mechanics drive the Calculator and native harness. Pyrokinesis is unchanged, and Cryokinesis stays cold. The [integration evaluation](surgical-damage-integration.md) records the full benchmark; the [candidate report](surgical-damage-candidates.md) retains the earlier experiments.
